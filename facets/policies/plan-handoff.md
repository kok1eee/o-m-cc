...
- `skills/quality-gate/reference.md` — code-reviewer / security-reviewer / critic の prompt
- `skills/editorial-swarm/SKILL.md` — 4 reviewer の prompt
- `agents/designer.md` / `agents/planner.md` — 設計 / タスク分解の入力受領
- `agents/critic.md` / `agents/code-reviewer.md` / `agents/security-reviewer.md` 等 — Council 出力
