...
**計画フェーズは承認ゲート付き、実装フェーズは止まらない。**

計画の各ステップで人間に確認を求め、方向性を合わせてから次に進む。
実装に入ったら Sisyphus Loop で完了まで止まらない。
